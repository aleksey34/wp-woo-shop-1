...
function estore_menu_init(){
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'estore' ),
		'secondary' => esc_html__( 'Secondary', 'estore' ),
	) );


	// change nav menu in widget nav menu   change args
	add_action("widget_nav_menu_args" , "est_footer_widget_nav_menu" , 20  );
	function est_footer_widget_nav_menu($nav_menu_args ){
 $nav_menu_args['menu_class'] = "info";
 return $nav_menu_args;
	}
}

add_action( 'after_setup_theme', 'estore_menu_init' );
